  ...
  <div class="w-full flex flex-col md:flex-row gap-y-8 md:gap-x-10 animate-pulse">
    ...
    <div class="w-full flex flex-col justify-center gap-y-4">
      ...
      <div class="flex flex-col gap-y-2">
        <span class="h-3 w-11/12 rounded-lg bg-background-secondary" />
        <span class="h-3 w-7/12 rounded-lg bg-background-secondary" />
      </div>
      <div class="flex gap-x-4">
        <span class="w-20 h-8 rounded-lg bg-background-secondary" />
        <span class="w-20 h-8 rounded-lg bg-background-secondary" />
        <span class="w-20 h-8 rounded-lg bg-background-secondary" />
      </div>
    </div>
